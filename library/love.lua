...
---
---
---[Open in Browser](https://love2d.org/wiki/Config_Files)
---
---@param t table # A table filled with all the default values which you can overwrite to your liking.
...
---
---The passed arguments excludes the game name and the fused command-line flag (if exist) when runs from non-fused LÖVE executable.
---
